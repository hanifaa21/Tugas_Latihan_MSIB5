...
<form  method="POST" action="{{ route('pelanggan.store') }}" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="form-check">
        <input name="jk" id="radio_0" type="radio" class="form-check" value="{{ $g }}" {{ $cek }}> 
        <label for="radio_0" class="custom-check-label">{{ $g }}</label>
      </div>  
        @endforeach
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text2" name="tmp_lahir" type="text2" class="form-control">
    </div>
  </div>
  <div class="form-group row">
